        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-purple-500/30 rounded-full"></div>
              <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-teal-500/20 rounded-full"></div>
            </div>
          </div>
