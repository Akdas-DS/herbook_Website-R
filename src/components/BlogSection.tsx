      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {blogPosts.map((post) => {
            ...
            return (
              <Card key={post.id} className="group bg-slate-800/50 border border-slate-700/50 shadow-lg hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                <div className="p-8">
